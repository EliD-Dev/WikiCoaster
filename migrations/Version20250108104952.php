...
final class Version20250108104952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coaster ADD COLUMN published BOOLEAN DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__coaster AS SELECT id, park_id, author_id, name, max_speed, length, max_height, operating FROM coaster');
        ...
        $this->addSql('INSERT INTO coaster (id, park_id, author_id, name, max_speed, length, max_height, operating) SELECT id, park_id, author_id, name, max_speed, length, max_height, operating FROM __temp__coaster');
